(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[8888],{30506:l=>{var a=`<div ng-transclude class="gf-form-query-content"></div>

`,t=a,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},34096:l=>{var a=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption" securesocksdsproxyenabled="secureSocksDSProxyEnabled">
`,t=a,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},99398:l=>{var a=`<div class="gf-form-group">
  <div class="gf-form">
...
`,t=a,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},40880:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},85462:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},96476:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},96576:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},31026:l=>{var a=`
...
`,t=a,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},35223:l=>{var a=`<div class="modal-body" ng-cloak>
...
`,t=a,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},49440:l=>{var a=`<div class="modal-header">
...
</div>`,t=a,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},18592:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},88973:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},62788:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},4725:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},29982:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},49268:l=>{var a=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,t=a,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},47603:l=>{var a=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,t=a,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},58640:l=>{var a=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,t=a,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},3132:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},22737:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},60129:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},96654:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},54416:l=>{var a=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,t=a,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},82442:l=>{var a=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,t=a,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},27067:l=>{var a=`<div class="table-panel-container">
...
`,t=a,e="public/app/plugins/panel/table-old/module.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},12631:(l,a,t)=>{var e={"./angular/panel/partials/query_editor_row.html":30506,"./angular/partials/http_settings_next.html":34096,"./angular/partials/tls_auth_settings.html":99398,"./features/admin/partials/admin_home.html":40880,"./features/admin/partials/edit_org.html":85462,"./features/admin/partials/stats.html":96476,"./features/admin/partials/styleguide.html":96576,"./features/annotations/partials/event_editor.html":31026,"./partials/confirm_modal.html":35223,"./partials/modal.html":49440,"./partials/reset_password.html":18592,"./partials/signup_invited.html":88973,"./plugins/panel/graph/axes_editor.html":62788,"./plugins/panel/graph/tab_display.html":4725,"./plugins/panel/graph/tab_legend.html":29982,"./plugins/panel/graph/tab_series_overrides.html":49268,"./plugins/panel/graph/tab_thresholds.html":47603,"./plugins/panel/graph/tab_time_regions.html":58640,"./plugins/panel/graph/thresholds_form.html":3132,"./plugins/panel/graph/time_regions_form.html":22737,"./plugins/panel/heatmap/partials/axes_editor.html":60129,"./plugins/panel/heatmap/partials/display_editor.html":96654,"./plugins/panel/table-old/column_options.html":54416,"./plugins/panel/table-old/editor.html":82442,"./plugins/panel/table-old/module.html":27067,"app/angular/panel/partials/query_editor_row.html":30506,"app/angular/partials/http_settings_next.html":34096,"app/angular/partials/tls_auth_settings.html":99398,"app/features/admin/partials/admin_home.html":40880,"app/features/admin/partials/edit_org.html":85462,"app/features/admin/partials/stats.html":96476,"app/features/admin/partials/styleguide.html":96576,"app/features/annotations/partials/event_editor.html":31026,"app/partials/confirm_modal.html":35223,"app/partials/modal.html":49440,"app/partials/reset_password.html":18592,"app/partials/signup_invited.html":88973,"app/plugins/panel/graph/axes_editor.html":62788,"app/plugins/panel/graph/tab_display.html":4725,"app/plugins/panel/graph/tab_legend.html":29982,"app/plugins/panel/graph/tab_series_overrides.html":49268,"app/plugins/panel/graph/tab_thresholds.html":47603,"app/plugins/panel/graph/tab_time_regions.html":58640,"app/plugins/panel/graph/thresholds_form.html":3132,"app/plugins/panel/graph/time_regions_form.html":22737,"app/plugins/panel/heatmap/partials/axes_editor.html":60129,"app/plugins/panel/heatmap/partials/display_editor.html":96654,"app/plugins/panel/table-old/column_options.html":54416,"app/plugins/panel/table-old/editor.html":82442,"app/plugins/panel/table-old/module.html":27067};function n(s){var r=o(s);return t(r)}function o(s){if(!t.o(e,s)){var r=new Error("Cannot find module '"+s+"'");throw r.code="MODULE_NOT_FOUND",r}return e[s]}n.keys=function(){return Object.keys(e)},n.resolve=o,l.exports=n,n.id=12631}}]);

//# sourceMappingURL=AngularApp.e1b289b092272f6aeed4.js.map