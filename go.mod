...
require (
	...
	cloud.google.com/go/storage v1.64.0 // @grafana/grafana-backend-group
	...
	google.golang.org/grpc v1.82.0 // @grafana/plugins-platform-backend
...
require (
	...
	google.golang.org/genproto v0.0.0-20260519071638-aa98bba5eb94 // indirect; @grafana/grafana-backend-group
