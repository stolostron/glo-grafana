...
// v1.1.4 is the last pre-module-split version of ugorji/go that still bundles
// the codec package inline, causing an "ambiguous import" conflict with the
// standalone github.com/ugorji/go/codec module. v1.1.7+ is a redirect-only
// module that resolves to github.com/ugorji/go/codec.
