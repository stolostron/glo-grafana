...
require (
	...
	github.com/docker/docker v28.1.1+incompatible // @grafana/grafana-release-guild
	...
	golang.org/x/exp v0.0.0-20250106191152-7588d65b2ba8 // @grafana/alerting-backend
